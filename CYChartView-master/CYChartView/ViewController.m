...
- (void)viewDidLoad {
    ...
    [_sliderLabel setText:[NSString stringWithFormat:@"点数量：%ld",(long)_totalCount] ];
...
- (void)drawChart
{
    ...
    // 创建绘图组件
    _chartView = [[CYChartView alloc] initWithFrame:CGRectMake(0, 230,[[UIScreen mainScreen] bounds].size.width, 200)];
