    ...
    for (int i = 0; i < [_graphAttributeAry count]; i++) {
        ...
        for(int j = 0; j < graphAttri.pointsCount; j++){
            ...
            if ((_maxPointCount == graphAttri.pointsCount) && j%intervalPointCount == 0
                ...
                xlabel.lineBreakMode = NSLineBreakByCharWrapping;
...
//            [selectBtn setTitle:@"001" forState:UIControlStateNormal];
...
- (void)drawReferenceLines{
    ...
    maxLabel.lineBreakMode = NSLineBreakByCharWrapping;
    ...
    minLabel.lineBreakMode = NSLineBreakByCharWrapping;
