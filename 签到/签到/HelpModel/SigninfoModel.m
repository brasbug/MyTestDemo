...
NSString *const kSigninfoModelbirthday = @"birthday";
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.birthday = [self objectOrNilForKey:kSigninfoModelbirthday fromDictionary:dict];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:self.birthday forKey:kSigninfoModelbirthday];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.birthday = [aDecoder decodeObjectForKey:kSigninfoModelbirthday];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_birthday forKey:kSigninfoModelbirthday];
